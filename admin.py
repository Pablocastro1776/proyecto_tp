...
import re
import os
from data import cargar_generos, guardar_usuarios,iterar_generos, guardar_generos,iterar_peliculas
...
def totalizar_peliculas_por_genero():
    try:
        conteo = {}
